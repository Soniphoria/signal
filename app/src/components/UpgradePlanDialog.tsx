...
export const UpgradePlanDialog: FC<UpgradePlanDialogProps> = ({ open, onClose }) => {
  const plans = [
    {
      name: 'Free Account',
      price: '$0',
        ...
        <div style={{
          ...
          {plans.map((plan) => (
            <div
              ...
              style={{
                padding: '1.5rem',
                border: plan.current ? '2px solid var(--color-theme)' : '1px solid var(--color-border)',
                borderRadius: '8px',
            ...
            >
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                {plan.features.map((feature, index) => (
                  <div key={index} style={{
                    color: feature.startsWith('✓') ? 'var(--color-text)' : 'var(--color-text-secondary)',
                    marginBottom: '0.5rem',
                    fontSize: '0.9rem'
                  }}>
                    {feature}
